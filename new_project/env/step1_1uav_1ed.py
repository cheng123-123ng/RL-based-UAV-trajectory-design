...
class _1Uav_1ED_Env(Env):
        ...
        self.observation_space = spaces.Dict(
            {
                ...
                "observations": spaces.Box(low=0, high=VIEWPORT_X, shape=((self.MAX_Ucar_num * 3 + 3+2*self.ed_num, )),dtype=int),
            }
        )
        self.Uav = None
        self.Ucar = []
    ...
    def step(self, action: int):
        ...
        if self.time_step==30 or self.ucar_end_num == self.MAX_Ucar_num:
            done=1
