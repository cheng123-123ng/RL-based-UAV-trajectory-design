...
def render(trajectroy=None,ed_num = 2 ,f = None):
    ...
    def init():
        ...
        # 返回曲线
        if ed_num == 1:
            return ln1,ln2,ln0_car,ln1_car,ln2_car,ln3_car,ln4_car,ln5
        elif ed_num==2:
            return ln1, ln2, ln0_car, ln1_car, ln2_car, ln3_car, ln4_car, ln5, ln6
        else:
            return ln1, ln2, ln0_car, ln1_car, ln2_car, ln3_car, ln4_car
    ...
    if ed_num >= 1:
        ...
        plt.legend(("uav0", "uav1", "ucar1", "ucar2", "ucar3", "ucar4", "ucar5"), loc="upper right")
